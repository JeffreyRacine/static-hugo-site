...
And, finally, we can create interactive HTML widgets using a simple R Markdown code chunk (enter 0.2 in the search bar which will filter on rows with a Petal Width of 0.2):
