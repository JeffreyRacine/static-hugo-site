...
Needless to say, I am grateful for this service as it allows me to collaborate with students and co-authors privately via GitHub for early-stage projects (once a project has resulted in a paper ready for circulation, I place that in the public sphere as working papers on [IDEAS/RePec](https://ideas.repec.org/e/pra175.html) and [SSRN](https://papers.ssrn.com/sol3/cf_dev/AbsByAuth.cfm?per_id=1401547) where they then get picked up by other services such as [Google Scholar](https://scholar.google.com/citations?user=TXeKxGsAAAAJ)). 
